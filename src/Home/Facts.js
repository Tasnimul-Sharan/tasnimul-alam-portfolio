...
// import { FaStackExchange, FaRegClock } from "react-icons/fa"; // Added a new clock icon
// import { GiProgression, GiGearHammer } from "react-icons/gi"; // Added an icon to indicate completion and technology
// import { MdWorkOutline } from "react-icons/md"; // Added work icon
...
//   return (
    ...
    //         <h1 className="text-xl font-bold mt-4">20+</h1>
    ...
    //         data-aos-duration="1000"
    //       >
    //         <GiProgression className="text-4xl text-primary" />
    ...
    //         data-aos-duration="1000"
    //       >
    //         <MdWorkOutline className="text-4xl text-primary" />
    //         <h1 className="text-xl font-bold mt-4">12h+</h1>
    ...
    //         <h1 className="text-xl font-bold mt-4">1</h1>
